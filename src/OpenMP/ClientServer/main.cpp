...
{
	#pragma offload target(mic:0) in(array[arrayCounter*arraySize:arraySize*numOfTransferedArrays] : into(array[0:arraySize*numOfTransferedArrays]) REUSE) \
	out(array[0:arraySize*numOfTransferedArrays] : into(array[arrayCounter*arraySize:arraySize*numOfTransferedArrays]) REUSE)
	{
