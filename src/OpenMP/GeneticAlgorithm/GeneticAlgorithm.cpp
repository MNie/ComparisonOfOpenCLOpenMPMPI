...
#pragma offload mandatory target(mic) \
  in(comparisonResultsPhi[0:populationPhi]:alloc(comparisonResultsPhi[0:0]) alloc_if(0) free_if(0)) \
  in(imagesRectanglesPhi[0:0]:alloc(imagesRectanglesPhi[0:0]) alloc_if(0) free_if(0))
...
#pragma offload mandatory target(mic) in(outputImagesPhi[0:0]:alloc(outputImagesPhi[0:numberOfThreadsOnPhi]) alloc_if(1) free_if(0) align(64)) \
  in(comparisionResultsPhi[0:0]:alloc(comparisionResultsPhi[0:population]) alloc_if(1) free_if(0) align(64)) \
  ...
  in(nativeImageAreaPhi[0:width*height]:alloc(nativeImageAreaPhi[0:width*height]) alloc_if(1) free_if(0) align(64))
    {
...
GeneticAlgorithm::~GeneticAlgorithm() {
    ...
    auto nativeImageAreaPhi = this->nativeImage->Area;
    int sizeOfRectangleTablePhi = this->sizeOfRectangleTable;
#pragma offload mandatory target(mic) in(outputImagesPhi[0:0]:alloc(outputImagesPhi[0:0]) alloc_if(0) free_if(1)) \
  in(comparisionResultsPhi[0:0]:alloc(comparisionResultsPhi[0:0]) alloc_if(0) free_if(1)) \
  in(imagesRectanglesPhi[0:0]:alloc(imagesRectanglesPhi[0:0]) alloc_if(0) free_if(1)) \
  in(nativeImagePhi[0:0]:alloc(nativeImagePhi[0:0]) alloc_if(0) free_if(1)) \
  in(nativeImageAreaPhi[0:0]:alloc(nativeImageAreaPhi[0:0]) alloc_if(0) free_if(1))
    {
...
#pragma offload mandatory target(mic) in(outputImagesPhi[0:0]:alloc(outputImagesPhi[0:0]) alloc_if(0) free_if(0)) \
  inout(comparisionResultsPhi[0:populationPhi]:alloc(comparisionResultsPhi[0:0]) alloc_if(0) free_if(0)) \
  in(imagesRectanglesPhi[0:sizeOfRectangleTablePhi]:alloc(imagesRectanglesPhi[0:0]) alloc_if(0) free_if(0)) \
...
#pragma offload mandatory target(mic) in(outputImagesPhi[0:0]:alloc(outputImagesPhi[0:0]) alloc_if(0) free_if(0)) \
  out(comparisionResultsPhi[0:populationPhi]:alloc(comparisionResultsPhi[0:0]) alloc_if(0) free_if(0)) \
  in(imagesRectanglesPhi[0:0]:alloc(imagesRectanglesPhi[0:0]) alloc_if(0) free_if(0)) \
  in(nativeImagePhi[0:0]:alloc(nativeImagePhi[0:0]) alloc_if(0) free_if(0)) \
  in(nativeImageAreaPhi[0:0]:alloc(nativeImageAreaPhi[0:0]) alloc_if(0) free_if(0))
#pragma omp parallel private(i, th_id)
